(function() {
  ...
  function isTokenExpired(token) {
    ...
    const expirationMs = claims.exp * 1e3;
    const nowMs = Date.now();
    return nowMs >= expirationMs - 3e4;
  }
  ...
  function getSnapshot() {
    if (store.cachedSnapshot !== null && store.lastAccessToken === store.accessToken && store.lastIdToken === store.idToken) {
  ...
  function setTokens(newAccessToken, newIdToken) {
  ...
  function initialize(initialAccessToken, initialIdToken) {
  ...
  function initializeTokenStore(accessToken, idToken) {
    initialize(accessToken, idToken);
  }
  function setStoreTokens(accessToken, idToken) {
    setTokens(accessToken, idToken);
  }
  function clearStoreTokens() {
    clearTokens();
  }
  const SERVICE_URLS = {
  ...
  async function submitFeedback(submission) {
    return apiRequest("POST", "/api/feedback", submission);
  }
  function UserBadge({ size = "md", showEmail = false }) {
    ...
    if (!isAuthenticated || !user) {
      ...
      `, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "widget-text-gray-500", children: "Anonymous" })
      ] });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `
      widget-flex widget-items-center widget-gap-2
    ...
    `, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "widget-flex widget-flex-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "widget-font-medium widget-text-gray-900", children: [
          user.name,
          isExpired && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "widget-ml-1 widget-text-widget-warning widget-text-xs", children: "(session expired)" })
        ] }),
        showEmail && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "widget-text-gray-500 widget-text-xs", children: user.email })
      ] })
    ] });
  }
  function FeedbackWidget({ theme = "light", onEvent }) {
    ...
    const renderStars = () => {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "widget-flex widget-gap-1", children: [1, 2, 3, 4, 5].map((star) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "svg",
              {
                className: `widget-w-8 widget-h-8 widget-transition-colors ${isActive ? "widget-text-yellow-400" : "widget-text-gray-300"}`,
                fill: "currentColor",
                viewBox: "0 0 20 20",
    ...
    if (submitState === "success") {
      ...
      `, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "widget-flex widget-flex-col widget-items-center widget-py-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "widget-w-16 widget-h-16 widget-rounded-full widget-bg-green-100 widget-flex widget-items-center widget-justify-center widget-mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: `widget-text-lg widget-font-semibold widget-mb-2 ${theme === "dark" ? "widget-text-white" : "widget-text-gray-900"}`, children: "Thank you!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `widget-text-sm ${theme === "dark" ? "widget-text-gray-300" : "widget-text-gray-600"}`, children: "Your feedback has been submitted." })
      ] }) });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `
      widget-container widget-p-6 widget-rounded-xl widget-shadow-widget
      ...
      widget-animate-fade-in
    `, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "widget-flex widget-items-center widget-justify-between widget-mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: `widget-text-lg widget-font-semibold ${theme === "dark" ? "widget-text-white" : "widget-text-gray-900"}`, children: "Send Feedback" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(UserBadge, { size: "sm" })
      ] }),
      !isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "widget-mb-4 widget-p-3 widget-bg-blue-50 widget-border widget-border-blue-100 widget-rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "widget-text-xs widget-text-blue-700", children: "💡 You're submitting as anonymous. Log in to the host app to submit with your account." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "widget-space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: `widget-block widget-text-sm widget-font-medium widget-mb-2 ${theme === "dark" ? "widget-text-gray-200" : "widget-text-gray-700"}`, children: "How would you rate your experience?" }),
          renderStars()
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "label",
            {
              ...
              className: `widget-block widget-text-sm widget-font-medium widget-mb-2 ${theme === "dark" ? "widget-text-gray-200" : "widget-text-gray-700"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
              ...
              ${theme === "dark" ? "widget-bg-gray-700 widget-border-gray-600 widget-text-white widget-placeholder-gray-400" : "widget-bg-white widget-border-gray-300 widget-text-gray-900 widget-placeholder-gray-400"}
            `
            }
          )
        ] }),
        errorMessage && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "widget-p-3 widget-bg-red-50 widget-border widget-border-red-100 widget-rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "widget-text-sm widget-text-red-700", children: errorMessage }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "submit",
            ...
            ${rating === 0 ? "widget-bg-gray-200 widget-text-gray-400 widget-cursor-not-allowed" : submitState === "submitting" ? "widget-bg-widget-primary/70 widget-text-white widget-cursor-wait" : "widget-bg-widget-primary widget-text-white hover:widget-bg-widget-primary-hover"}
          `,
            children: submitState === "submitting" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "widget-flex widget-items-center widget-justify-center widget-gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "widget-mt-4 widget-pt-4 widget-border-t widget-border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `widget-text-xs widget-text-center ${theme === "dark" ? "widget-text-gray-400" : "widget-text-gray-500"}`, children: "Powered by Widget Demo" }) })
    ] });
  }
  let root = null;
  let shadowRoot = null;
  let currentConfig = null;
  const WIDGET_SCRIPT_URL = document.currentScript ? document.currentScript.src : "";
  ...
  function WidgetWrapper({ config }) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      FeedbackWidget,
      {
        theme: config.theme,
  ...
  function render() {
    ...
    root.render(
      /* @__PURE__ */ jsxRuntimeExports.jsx(WidgetWrapper, { config: currentConfig })
    );
  }
    ...
    return {
      ...
      async init(config) {
        ...
        if (root) {
          ...
          render();
          (_a = config.onEvent) == null ? void 0 : _a.call(config, { type: "INITIALIZED" });
          return;
        }
        ...
        if (!container) {
          ...
          console.error(error);
          (_b = config.onEvent) == null ? void 0 : _b.call(config, { type: "ERROR", payload: { message: error, code: "CONTAINER_NOT_FOUND" } });
          return;
        }
        currentConfig = config;
        initializeTokenStore(config.accessToken, config.idToken);
        ...
        let shadowContainer = shadowRoot.querySelector("#widget-shadow-root");
        if (!shadowContainer) {
        ...
        root = clientExports.createRoot(shadowContainer);
        render();
        ...
        (_c = config.onEvent) == null ? void 0 : _c.call(config, { type: "INITIALIZED" });
      },
      /**
      ...
      destroy() {
        ...
        clearStoreTokens();
        setApiAccessToken(null);
        (_a = currentConfig == null ? void 0 : currentConfig.onEvent) == null ? void 0 : _a.call(currentConfig, { type: "DESTROYED" });
        currentConfig = null;
